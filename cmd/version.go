...
func FormattedVersion() string {
	...
	fmt.Fprintf(&versionString, "Suprasched v")
...
var versionCmd = &cobra.Command{
	Use:   "version",
	Short: "Print the version number of Suprasched",
	Long:  `All software has versions. This is Suprasched's`,
